        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    DataflowDiagramId = table.Column<Guid>(type: "uuid", nullable: true)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                {
                    Id = table.Column<Guid>(type: "uuid", nullable: false),
                    P1Id = table.Column<Guid>(type: "uuid", nullable: false),
                    P2Id = table.Column<Guid>(type: "uuid", nullable: false),
                    DataflowDiagramId = table.Column<Guid>(type: "uuid", nullable: true)
                },
                constraints: table =>
                {
